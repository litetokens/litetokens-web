const LitetokensWeb = require('../../dist/LitetokensWeb.node.js');

const fullNode = 'https://api.shasta.litescan.org';
const solidityNode = 'https://api.shasta.litescan.org';
const eventServer = 'https://api.shasta.litescan.org/';
